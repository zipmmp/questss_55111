import { ActionRowBuilder, EmbedBuilder, SlashCommandUserOption, StringSelectMenuBuilder } from "discord.js";
...
export default class BoostCommand extends SlashCommand {
    constructor() {
        super(...arguments);
        this.name = "boost";
