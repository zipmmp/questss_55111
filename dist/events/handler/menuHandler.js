...
export default class menuHandler extends baseDiscordEvent {
    ...
    async executeEvent(interaction) {
        if ((!interaction.isContextMenuCommand() && !interaction.isAnySelectMenu()) || !this.client.ready)
            return;
        ...
        const command = this.client.menus.get(name) || this.client.menus.find(e => e.type === type && e.passFilter(interaction));
        if (!command)
            return;
